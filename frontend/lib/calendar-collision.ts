...
/**
 * Converts a time string (12h AM/PM, 24h, or midnight boundary) to decimal hours (9.0 to 24.0).
 */
export function parseTimeToHour(timeStr: string): number {
  ...
  if (clean === "12:00 am" || clean === "00:00" || clean === "24:00") return 24
