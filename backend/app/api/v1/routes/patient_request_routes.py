...
router = APIRouter(prefix="/patient-requests", tags=["Patient Requests (Simulator)"])
...
@router.post("/{request_id}/reject", response_model=PatientRequestResponse, status_code=status.HTTP_200_OK)
